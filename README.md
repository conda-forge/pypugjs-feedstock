...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/pypugjs-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/pypugjs-feedstock)
...
Once the `conda-forge` channel has been enabled, `pypugjs` can be installed with:

```
conda install pypugjs
```

It is possible to list all of the versions of `pypugjs` available on your platform with:
